...
// https://t.me/smartmarket_community/28479
// {"type":"text","text":"первая фраза","state":"/newNode_46","lang":"ru","tts":"первая фраза"},
function _reply(body, response){
    response.replies = response.replies || [];
    response.replies.push(body);
}
